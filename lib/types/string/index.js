...
internals.String = class extends Any {
    ...
    match(matchs) {
        ...
        return this._test('match', undefined, function (value, state, options) {
            if (Array.isArray(matchs) && matchs.indexOf(value) > -1) {
                return value;
            } else if (typeof matchs === 'string' && matchs === value) {
                return value;
            } else {
                return this.createError('string.match', {value}, state, options);
            }
        });
    }
